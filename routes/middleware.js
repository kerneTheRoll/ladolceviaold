...
exports.detectLang = function(req, res, next) {
    var match = req.url.match(/^\/(de|en|it)([\/\?].*)?$/i);
    ...
    if (match) {
		...
		res.cookie('i18n',match[1] );
		// reset the URL for routing
		
	
		
    } else {
		//qui ogni router che si presenta a root senza aver la lingua dovrà essere passato come lingua ufficiale /it
